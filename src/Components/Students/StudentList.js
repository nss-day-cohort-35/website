        ...
        return (
            <>
                <div>
                    ...
                    Part of us went onto <span id="cohortFrontend"> concentrate on UI/UX design </span> and others on <span id="cohortBackend"> server-side .NET and C#. </span> Combined, we join those skillsets to create user-centric front and backend applications. </p>
                </div>
